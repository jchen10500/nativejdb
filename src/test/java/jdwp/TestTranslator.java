...
public class TestTranslator {
     ...
     */
    @Test
    public void testJointPrimitives() {

        String zeroPrimitiveInput = "HelloMethod.HelloMethod::hello()";
        String zeroPrimitivesExpected = "HelloMethod/HelloMethod::hello()";
        String zeroPrimitivesActual = Translator.normalizeFunc(zeroPrimitiveInput);
        assertEquals("Zero parameters should be translated to ()", zeroPrimitivesExpected, zeroPrimitivesActual);

        String twoPrimitivesInput = "HelloMethod.HelloMethod::hello(boolean, byte)";
        String twoPrimitivesExpected = "HelloMethod/HelloMethod::hello(ZB)";
        String twoPrimitivesActual = Translator.normalizeFunc(twoPrimitivesInput);
        assertEquals("Boolean and byte parameters should be translated to (ZB)", twoPrimitivesExpected, twoPrimitivesActual);

        String threePrimitivesInput = "HelloMethod.HelloMethod::hello(double, int, float)";
        String threePrimitivesExpected = "HelloMethod/HelloMethod::hello(DIF)";
        String threePrimitivesActual = Translator.normalizeFunc(threePrimitivesInput);
        assertEquals("Boolean and byte parameters should be translated to (DIF)", threePrimitivesExpected, threePrimitivesActual);
    }
